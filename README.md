...
Caso não possuir uma Chave APi, basta apenas criar uma nova, mas nunca compartilhe com estranhos a sua chave api e caso isso acontecer, delete sua chave api e crie uma nova!
